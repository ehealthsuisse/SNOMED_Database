...
public class CreateBetaDB {
	...
	static String ReleaseFilePath = "/home/stefanieneuenschwander/Dokumente/SNOMEDReleases/InternationalReleases/SnomedCT_InternationalRF2_PRODUCTION_20260601T120000Z"; // Path to the International Edition
	static String ReleaseFilePathCH = "/home/stefanieneuenschwander/Dokumente/SNOMEDReleases/BetaReleases/SnomedCT_ManagedServiceCH_DAILYBUILD_BETA_CH1000195_20261207T120000Z"; // Path to the Swiss Extension
	static String ReleaseDate = "20260601";
	static String ReleaseDateCH = "CH1000195_20261207";

	public static void main(String[] args) {
        // Normalize paths to forward slashes for cross-platform MySQL compatibility
        String rfPath = ReleaseFilePath.replace('\\', '/');
        String rfPathExt = ReleaseFilePathCH.replace('\\', '/');
        
		// Datenbankverbindung konfigurieren
		String dbName = "SCT:CH_Beta_Juni26";
...
//		    System.out.println(createModuleDependencyRefsetTableQuery);
			...
			String importConceptsIntEdQuery = "LOAD DATA LOCAL INFILE '" + rfPath+ "/Full/Terminology/sct2_Concept_Full_INT_" + ReleaseDate + ".txt'\r\n"
...
//		    System.out.println(importConceptsIntEdQuery);
			System.out.println("Import SNOMED International Edition Release " + ReleaseDate + " concepts successfull!");

			String importDescriptionIntEdQuery = "LOAD DATA LOCAL INFILE '" +rfPath+"/Full/Terminology/sct2_Description_Full-en_INT_" + ReleaseDate + ".txt'\r\n"
...
//		    System.out.println(importDescriptionIntEdQuery);
			System.out.println(
					"Import SNOMED International Edition Release " + ReleaseDate + " descriptions successfull!");

			String importRelationshipIntEdQuery = "LOAD DATA LOCAL INFILE '" +rfPath+"/Full/Terminology/sct2_Relationship_Full_INT_" + ReleaseDate + ".txt'\r\n"
...
//		    System.out.println(importRelationshipIntEdQuery);
			System.out.println(
					"Import SNOMED International Edition Release " + ReleaseDate + " relationships successfull!");
...
//		            System.out.println(importSimpleRefsetIntEdQuery);
			...
			String importLanguageRefsetsIntEdQuery = "LOAD DATA LOCAL INFILE '" +rfPath+"/Full/Refset/Language/der2_cRefset_LanguageFull-en_INT_" + ReleaseDate + ".txt'\r\n"
...
//		    System.out.println(importLanguageRefsetsIntEdQuery);
			System.out.println(
					"Import SNOMED International Edition Release " + ReleaseDate + " language refsets successfull!");
...
//		            System.out.println(importExtendedMapRefsetsIntEdQuery);
			...
			String importConceptsCHdQuery = "LOAD DATA LOCAL INFILE '" +rfPathExt+"/Snapshot/Terminology/sct2_Concept_Snapshot_" + ReleaseDateCH + ".txt'\r\n"
					+ "INTO TABLE `full_concept`\r\n" 
					+ "LINES TERMINATED BY '\\r\\n'\r\n" 
					+ " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`definitionStatusId`);";
...
//		    System.out.println(importConceptsCHdQuery);
			System.out.println("Import Swiss Extension Release " + ReleaseDate + " concepts successfull!");

			String importDescriptionDeCHQuery = "LOAD DATA LOCAL INFILE '" +rfPathExt+"/Snapshot/Terminology/sct2_Description_Snapshot-de-ch_" + ReleaseDateCH + ".txt'\r\n"
					+ "INTO TABLE `full_description`\r\n" 
					+ "LINES TERMINATED BY '\\r\\n'\r\n" 
					+ " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`conceptId`,`languageCode`,`typeId`,`term`,`caseSignificanceId`);";
...
//		    System.out.println(importDescriptionDeCHQuery);
			System.out.println("Import Swiss Extension Release " + ReleaseDate + " german descriptions successfull!");

			String importDescriptionFrCHQuery = "LOAD DATA LOCAL INFILE '" +rfPathExt+"/Snapshot/Terminology/sct2_Description_Snapshot-fr-ch_" + ReleaseDateCH + ".txt'\r\n"
					+ "INTO TABLE `full_description`\r\n" 
					+ "LINES TERMINATED BY '\\r\\n'\r\n" 
					+ " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`conceptId`,`languageCode`,`typeId`,`term`,`caseSignificanceId`);";
...
//		    System.out.println(importDescriptionFrCHQuery);
			System.out.println("Import Swiss Extension Release " + ReleaseDate + " french descriptions successfull!");

			String importDescriptionItCHQuery = "LOAD DATA LOCAL INFILE '" +rfPathExt+"/Snapshot/Terminology/sct2_Description_Snapshot-it-ch_" + ReleaseDateCH + ".txt'\r\n"
					+ "INTO TABLE `full_description`\r\n" 
					+ "LINES TERMINATED BY '\\r\\n'\r\n" 
					+ " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`conceptId`,`languageCode`,`typeId`,`term`,`caseSignificanceId`);";
...
//		    System.out.println(importDescriptionItCHQuery);
			System.out.println("Import Swiss Extension Release " + ReleaseDate + " italian descriptions successfull!");

			String importDescriptionEnCHQuery = "LOAD DATA LOCAL INFILE '" +rfPathExt+"/Snapshot/Terminology/sct2_Description_Snapshot-en_" + ReleaseDateCH + ".txt'\r\n"
					+ "INTO TABLE `full_description`\r\n" 
					+ "LINES TERMINATED BY '\\r\\n'\r\n" 
					+ " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`conceptId`,`languageCode`,`typeId`,`term`,`caseSignificanceId`);";
...
//		    System.out.println(importDescriptionEnCHQuery);
			System.out.println("Import Swiss Extension Release " + ReleaseDate + " english descriptions successfull!");

			String importRelationshipCHQuery = "LOAD DATA LOCAL INFILE '" +rfPathExt+"/Snapshot/Terminology/sct2_Relationship_Snapshot_" + ReleaseDateCH + ".txt'\r\n"
					+ "INTO TABLE `full_relationship`\r\n" 
					+ "LINES TERMINATED BY '\\r\\n'\r\n" 
					+ " IGNORE 1 LINES\r\n"
					+ "(`id`,`effectiveTime`,`active`,`moduleId`,`sourceId`,`destinationId`,`relationshipGroup`,`typeId`,`characteristicTypeId`,`modifierId`);";
...
//		            System.out.println(importRelationshipCHQuery);
			System.out.println("Import Swiss Extension Release " + ReleaseDate + " relationship successfull!");
...
//		            statement.executeUpdate(importSimpleRefsetCHQuery);
			...
			String importLanguageRefsetsDeCHQuery = "LOAD DATA LOCAL INFILE '" +rfPathExt+"/Snapshot/Refset/Language/der2_cRefset_LanguageSnapshot-de-ch_" + ReleaseDateCH
					+ ".txt'\r\n" 
					+ "INTO TABLE `full_refset_Language`\r\n" 
					+ "LINES TERMINATED BY '\\r\\n'\r\n"
					+ " IGNORE 1 LINES\r\n"
...
//		    System.out.println(importLanguageRefsetsDeCHQuery);
			System.out.println("Import Swiss Extension Release " + ReleaseDate + " german language refset successfull!");

			String importLanguageRefsetsFrCHQuery = "LOAD DATA LOCAL INFILE '" +rfPathExt+"/Snapshot/Refset/Language/der2_cRefset_LanguageSnapshot-fr-ch_" + ReleaseDateCH
					+ ".txt'\r\n" 
					+ "INTO TABLE `full_refset_Language`\r\n" 
					+ "LINES TERMINATED BY '\\r\\n'\r\n"
					+ " IGNORE 1 LINES\r\n"
...
//		    System.out.println(importLanguageRefsetsFrCHQuery);
			System.out.println("Import Swiss Extension Release " + ReleaseDate + " french language refset successfull!");

			String importLanguageRefsetsItCHQuery = "LOAD DATA LOCAL INFILE '" +rfPathExt+"/Snapshot/Refset/Language/der2_cRefset_LanguageSnapshot-it-ch_" + ReleaseDateCH
					+ ".txt'\r\n" 
					+ "INTO TABLE `full_refset_Language`\r\n" 
					+ "LINES TERMINATED BY '\\r\\n'\r\n"
					+ " IGNORE 1 LINES\r\n"
...
//		    System.out.println(importLanguageRefsetsItCHQuery);
			System.out.println("Import Swiss Extension Release " + ReleaseDate + " italian language refset successfull!");

			String importLanguageRefsetsEnCHQuery = "LOAD DATA LOCAL INFILE '" +rfPathExt+"/Snapshot/Refset/Language/der2_cRefset_LanguageSnapshot-en_" + ReleaseDateCH
					+ ".txt'\r\n" 
					+ "INTO TABLE `full_refset_Language`\r\n" 
					+ "LINES TERMINATED BY '\\r\\n'\r\n"
					+ " IGNORE 1 LINES\r\n"
...
//		    System.out.println(importLanguageRefsetsEnCHQuery);
			System.out.println("Import Swiss Extension Release " + ReleaseDate + " english language refset successfull!");
